...
async function diagnose() {
    ...
    try {
        ...
        fs.writeFileSync('scripts/user_diagnosis_report.json', JSON.stringify(report, null, 2), 'utf8');
        console.log("Diagnostic report saved to scripts/user_diagnosis_report.json");
